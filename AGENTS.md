...
11. **AMSTERDAM FOUR: EXCEPCIÓN ÚNICA Y CERRADA.**
    - Amsterdam Four queda prohibida en toda la invitación salvo una única excepción ya aprobada.
    - La única sección autorizada para usar Amsterdam Four es el texto: **“¡Falta poco para el gran día y queremos celebrarlo contigo!”**, correspondiente a `.celebration-copy-script`.
    - No usar Amsterdam Four en `Lucero & Antonio`, títulos, fechas, ubicación, programa, regalos, preguntas, pie de página ni ninguna sección futura.
    - No crear nuevas excepciones sin una instrucción expresa del usuario.
